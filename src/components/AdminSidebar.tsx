...
export default function AdminSidebar({ activeTab, setActiveTab, isOpen, onClose }: AdminSidebarProps) {
    ...
    return (
        <>
            ...
            <aside className={`fixed lg:sticky top-0 left-0 h-screen bg-slate-950 border-r border-slate-800/50 flex flex-col p-6 z-50 shadow-2xl transition-all duration-300 transform 
